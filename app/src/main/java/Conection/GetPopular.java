...
public class GetPopular {
    ...
    public static void getPopular(final Context context, final GridView listView, final LinearLayout linearLayout, final ProgressBar progressBar) {
        Factory.getIntance()
                .getPopular(Variables.getPublic_key()).enqueue(new Callback<Movies>() {
            @Override
